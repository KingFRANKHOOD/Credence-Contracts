...
fn setup_with_bond(e: &Env, amount: i128, duration: u64) -> (CredenceBondClient<'_>, Address, Address) {
...
fn test_slash_multiple_accumulate() {
    ...
    for i in 1..=5 {
        ...
        let capped = if expected_slashed > 10000_i128 { 10000_i128 } else { expected_slashed };
